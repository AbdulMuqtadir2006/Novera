// API layer — talks to the Novera backend (Express + SQLite + Claude).
...
export const runPipeline = () => req("/orchestrator/run", { method: "POST", body: "{}" });
export const orchestratorWhatsApp = (message) =>
  req("/orchestrator/whatsapp", { method: "POST", body: JSON.stringify({ message }) });
